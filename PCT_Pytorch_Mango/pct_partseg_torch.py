...
class Point_Transformer_partseg(nn.Module):
    ...
    def forward(self, x, cls_label):
        ...
        print(f'One gather pass: {end_gather - start_gather}')
        ...
        end_fwd = time.time()
        print(f'One full forward pass: {end_fwd - start_fwd}')
        return x
...
class Point_Transformer_partseg_old(nn.Module):
    def __init__(self, part_num=50):
        super(Point_Transformer_partseg_old, self).__init__()
        self.part_num = part_num
...
class Point_Transformer_partseg_CIC(nn.Module):
    def __init__(self, part_num=50):
        super(Point_Transformer_partseg_old, self).__init__()
        self.part_num = part_num
        self.conv1 = nn.Conv1d(3, 128, kernel_size=1, bias=False)
